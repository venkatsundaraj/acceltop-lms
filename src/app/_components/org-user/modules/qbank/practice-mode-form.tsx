...
// const PracticeModeForm: FC<PracticeModeFormProps> = ({}) => {
...
//   } = useForm<FilterCategoryWithoutStatus>({
//     resolver: zodResolver(filterCategoryWithoutStatus),
//   });
...
//   const submitHandler = function (data: FilterCategoryWithoutStatus) {
//     console.log(data);
//   };
//   return (
...
//         className="grid grid-cols-2 md:grid-cols-3 items-center justify-center mt-8 gap-8"
//       >
